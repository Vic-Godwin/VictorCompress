...
class VictorCompressApp:
    ...
    def open_reader(self):
        ...
        try:
            ...
            subprocess.Popen(["python", "readfile.py", self.output_file_path])
...
class VictorCompressApp:
    def __init__(self, root):
        ...
        self.read_btn = GlowButton(self.root, text="Open Reader", glow_color="#00ff88")#, command=self.open_reader)
